        ...
        <script dangerouslySetInnerHTML={{__html: `
          ...
          OneSignalDeferred.push(async function(OneSignal) {
            await OneSignal.init({
              ...
              safari_web_id: "web.onesignal.auto.f0a96e08-77cb-48fa-989e-70640ff2380f",
              ...
              promptOptions: {
                slidedown: {
                  prompts: [{
                    ...
                    autoPrompt: true,
                    text: {
                      actionMessage: "FamilyVerse wants to send you notifications for chat messages, medicine reminders and SOS alerts.",
                      acceptButton: "Allow 🔔",
                      cancelButton: "Later"
                    },
